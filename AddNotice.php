...
<div class="page-content">
					...
					<div class="col-md-12 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								<h6 class="card-title">Add New Notice</h6>
								<form class="forms-sample">
									<div class="form-group row">
										<label for="exampleInputTitle" class="col-sm-3 col-form-label">Title</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="exampleInputTitle" placeholder="Title" required>
										</div>
									</div>
									<div class="form-group row">
										<label for="exampleInputNotice" class="col-sm-3 col-form-label">Notice</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="exampleInputNotice" autocomplete="off" placeholder="Notice">
										</div>
									</div>
