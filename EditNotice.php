...
<div class="page-content">
                ...
                <div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="number" class="form-control" id="exampleInputNotice" autocomplete="off" placeholder="Notice">
										</div>
									</div>
									<div class="form-group row">
										<label for="exampleInputTitle" class="col-sm-3 col-form-label">Notice</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="exampleInputTitle" placeholder="Notice" required>
										</div>
									</div>	
